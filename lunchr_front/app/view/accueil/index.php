...
<div class="modal fade geoloc-modal-lg" id="mymodal_geoloc" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="text-center new_password_content modal-content col-lg-12 col-sm-12 col-sm-12">
            <img class="text-center" src="img/loader.gif"/>
            <h2 class="text-center font_open_sansbold">GEOLOCALISATION EN COURS !</h2>
        </div>
    </div>
</div>
                        ...
                        <div class="container">
                            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<form class="form-inline col-lg-12 form_recherche text-center" role="form" method="post" action="">
									...
									<button class="fa fa-map-marker" id="geolocalisation" data-toggle="modal" data-target=".geoloc-modal-lg"></button>   
                        		</form>
                            </div>
                    </div>
                    <!-- Large modal -->
                ...
                <div class="col-lg-12 pad20 suggestions">
                 <?php foreach ($suggestion as $key => $row) {
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-sxs text-center marg global_hover">
                        <a href="index.php?module=menu&action=menu&id=<?php echo $row['lr_id'] ?>"><img src="<?php echo $row['lr_image_1']?>" width="" height="" alt="restaurant"/></a>
...
-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="barre col-lg-4"></div>
                    <h2 class='col-lg-4 text-center main_color font_open_sansbold how_work_clic_test'>HOW DOES IT WORK</h2>
                    <div class="barre col-lg-4"></div>
                </div>
                <div class="col-lg-12 pad20">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-sxs text-center hdiw_bloc">
                        <img alt="" src="img/icone_1_red.png"/>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 col-sxs text-center hdiw_bloc">
                        <img alt="" src="img/icone_4_red.png"/>
