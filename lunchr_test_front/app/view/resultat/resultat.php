        ...
        <div class="row">
          <a href="#" onClick="ga('send', 'event', 'searchfilter', 'clic');">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mg-t10 num_result">
                ...
                <div><?php echo count($search); ?> restaurants match your criteria</div>
            </div>
          </a>
            <!--DEBUT  SEARCH FILTER -->
            ...
            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 marg_tb10 dish_content no_pad ">
              <div class="col-lg-2 col-md-2 col-sm-2 col-xs-4 no_pad  resp_img">
                <div class="dish_img bck_restaurant01"><img src='<?php echo $row['lr_image_1'] ?>' alt='image_restaurant' title='image restaurant' width='180px' height='155px'/></div>
              </div>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no_pad  horaires_result">
                <img alt="horaire01" src="img/horaire_dispo.png">
                <img alt="horaire02" src="img/horaire02.png">
                <img alt="horaire03" src="img/horaire_dispo02.png">
              </div>
