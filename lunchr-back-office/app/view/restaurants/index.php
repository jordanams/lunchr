           ...
           <div>
	            <table id="tableau" class="table">
	                  ...
	                  <tr>
	                        ...
	                        <th height="40" width="110">Horraire</th>
	                  ...
	                  <?php foreach ($afficher_resto as $key => $row) {
	                              ...
	                              echo"<td>".$row[2]."</td>";
	                              echo"<td>".$row[3]."</td>";
	                              echo'<td><a href="index.php?module=restaurants&action=details_resto&id='.$row[4].'">Détails</a></td>';
	                              echo'<td id="supp1"><a href="index.php?module=restaurants&action=supp_resto&id='.$row[4].'" onclick="return confirm_delete_resto()">Supprimer</a></td>';
	                              echo"</tr>";
	                        }
	                  ?>
	            </table>
