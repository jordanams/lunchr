           	...
           	<div>
	            <table id="tableau" class="table">
	                  ...
	                  <?php foreach ($afficher_users as $key => $row) {
	                              ...
	                              echo"<td>".$row[3]."</td>";
	                              echo"<td>".$row[4]."</td>";
	                              echo'<td><a href="index.php?module=utilisateurs&action=details_users&id='.$row[5].'">Détails</a></td>';
	                              echo'<td><a href="index.php?module=utilisateurs&action=supp_users&id='.$row[5].'&type=normal" onclick="return confirm_delete_users()">Supprimer</a></td>';
	                              echo"</tr>";
	                        }
	                  ?>
	            </table>
