...
function insert_resto($nom_resto, $adresse_resto, $longitude, $latitude, $pays, $ville, $code_postal, $desc_resto, $avatar1, $avatar2, $avatar3, $avatar4, $user_id) {
	...
	try {
		...
		$curseur->bindValue(':user_id', $user_id, PDO::PARAM_STR);
