...
function update_resto($desc_resto, $avatar1, $avatar2, $avatar3, $avatar4, $id_resto) {
...
/****************  Image n°1  ****************/
	...
	if($_FILES['ch_file1']['name'] == "") {
			...
			if($_SESSION['restaurant_image_1'] == "") {
				$avatar1="";
			}
				else {
					$avatar1=$_SESSION['restaurant_image_1'];
				}
	}
...
/****************  Image n°2  ****************/
	...
	if($_FILES['ch_file2']['name'] == "") {
			...
			if($_SESSION['restaurant_image_2'] == "") {
				$avatar2="";
			}
				else {
					$avatar2=$_SESSION['restaurant_image_2'];
			}	
	}
...
/****************  Image n°3  ****************/
	...
	if($_FILES['ch_file3']['name'] == "") {
			...
			if($_SESSION['restaurant_image_3'] == "") {
				$avatar3="";
			}
				else {
					$avatar3=$_SESSION['restaurant_image_3'];
				}
	}
...
/****************  Image n°4  ****************/
	...
	if($_FILES['ch_file4']['name'] == "") {
			...
			if($_SESSION['restaurant_image_4'] == "") {
				$avatar4="";
			}
				else {
					$avatar4=$_SESSION['restaurant_image_4'];
			}
	}
