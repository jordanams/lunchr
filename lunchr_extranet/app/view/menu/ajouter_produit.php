					...
					<script type="text/javascript">
						...
						<div>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input required id="nom_produit" name="nom_produit" type="text" placeholder="Nom du produit" class="form-control input-md">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input required id="prix_produit" name="prix_produit" type="text" placeholder="Prix du produit" class="form-control input-md">
								</div>
							</div>

							<div class="form-group">
								<label class="col-md-3 control-label" for="selectbasic">Quantitées du produit</label>
								<div class="col-md-5">
									<input required id="nbr_produit" name="nbr_produit" type="text" value="10" class="form-control input-md">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<textarea required id="desc_produit" name="desc_produit" class="form-control" placeholder="Description du produit"></textarea>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-md-5">
									<input required id="ch_file1" name="ch_file1" class="input-file" type="file">
								</div>
							</div>
