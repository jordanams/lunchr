					...
					<fieldset>
						...
						<div class="form-group">
						  ...
						  <div class="col-md-4" align="center">
						  	<?php if($verif_details[0]['lr_actif_attente'] == 1 OR $verif_details[0]['lr_supp_attente'] == 1) { echo '';} else {echo '<font size="6"><a class="bouton_lien" href="index.php?module=restaurant&action=update_resto&id_resto='.$verif_details[0]['lr_id'].'">Modifier</a></font>';}?>
						  </div>
						</div>
					</fieldset>
				</form>
