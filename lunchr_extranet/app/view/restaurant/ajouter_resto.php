	        	...
	        	<form class="form-horizontal" id="formu_resto" name="formu_resto" action="" method="POST" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="form-group">
						  <label class="col-md-4 control-label" for="filebutton">Ajouter une image</label>
						  <div class="col-md-4">
						    <input id="img2_resto" name="ch_file2" class="input-file" type="file">
						  </div>
						</div>
						...
						<div class="form-group">
						  <label class="col-md-4 control-label" for="filebutton">Ajouter une image</label>
						  <div class="col-md-4">
						    <input id="img3_resto" name="ch_file3" class="input-file" type="file">
						  </div>
						</div>
						...
						<div class="form-group">
						  <label class="col-md-4 control-label" for="filebutton">Ajouter une image</label>
						  <div class="col-md-4">
						    <input id="img4_resto" name="ch_file4" class="input-file" type="file">
						  </div>
						</div>
