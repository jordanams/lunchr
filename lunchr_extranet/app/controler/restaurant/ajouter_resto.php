<?php
include('../app/model/restaurant/insert_new_resto.php');
	...
	if(isset($_POST['nom_resto'])) {
		...
		if($insert = true) {
			...
			if($notif_insert = true) {
				header('Location:index.php?module=restaurant&action=attente_valid');
			}
		}
	}

include('../app/view/restaurant/ajouter_resto.php'); 
?>