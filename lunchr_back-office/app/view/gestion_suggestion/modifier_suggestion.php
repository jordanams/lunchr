              ...
              <div class="row">
                ...
                <div class="col-md-3">
                  <?php foreach ($gestion_suggestion as $key => $row) {
                    $ordre = $key+1;
                    echo'<label for="textinput">Suggestion '.$ordre.' :</label><input id="textinput" disabled="disabled" name="textinput" type="text" placeholder="'.$row['lr_nom'].'" class="form-control input-md"><br/>';
                  }
                  ?>
                </div>
