<ul class="nav nav-tabs nav-justified" role="tablist">
    ...
    <li role="presentation"<?php if($_GET['action']=='resto_en_suppression') { echo' class="active"'; } ?>><a href="index.php?module=restaurants&action=resto_en_suppression">Listes des restaurants en suppression</a></li>
